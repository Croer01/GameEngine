...
# This recipe is a modified version of https://github.com/bincrafters/conan-sdl2_image
# to fit with the requirements of this project
class SDL2ImageConan(ConanFile):
    ...
    def source(self):
        ...
        os.rename(extracted_dir, self.subfolder)
    ...
    def build(self):
        ...
        if self.options.jpg == 'libjpeg':
            cmake.definitions['JPG_DYNAMIC'] = self.options['libjpeg'].shared
        elif self.options.jpg == 'libjpeg':
            cmake.definitions['JPG_DYNAMIC'] = self.options['libjpeg-turbo'].shared
        else:
            cmake.definitions['JPG_DYNAMIC'] = False
    ...
    def package(self):
        self.copy(pattern="LICENSE", dst="licenses", src=self.subfolder)
